package org.isaagents.helpbrowser.ui;

import com.explodingpixels.macwidgets.IAppWidgetFactory;
import org.isaagents.helpbrowser.common.UIHelper;
import org.isaagents.helpbrowser.effects.AnimatableJFrame;
import org.isaagents.helpbrowser.effects.TopPane;
...
public class WebBrowser extends AnimatableJFrame {
    ...
    static {
        ...
        UIManager.put("AgentTip.foreground", UIHelper.LIGHT_GREEN_COLOR);
        UIManager.put("AgentTip.background", Color.white);
    ...
    class AddressPanel extends JPanel {
        ...
        private void constructPanel() {
            ...
            back.setAgentTipText("<html>Go back a page</html>");

            forward = new JLabel(forwardIcon);
            forward.setEnabled(false);
            forward.setAgentTipText("<html>Go forward a page</html>");

            home = new JLabel(homeIcon);
            home.setAgentTipText("<html>Go home</html>");

            viewHistory = new JLabel(historyIcon);
            viewHistory.setAgentTipText("<html>View your history</html>");
